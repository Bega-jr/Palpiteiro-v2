...
export function Results() {
    ...
    const fetchResults = async () => {
      try {
        ...
        const response = await fetch(
          'https://palpiteiro-ia-backend-docker.onrender.com/api/resultados'
        );
  ...
  const openDebug = () => {
    window.open('https://palpiteiro-ia-backend-docker.onrender.com/api/debug', '_blank');
  };

  // Abre o reset em nova aba
  const openReset = () => {
    window.open('https://palpiteiro-ia-backend-docker.onrender.com/api/reset', '_blank');
  };
