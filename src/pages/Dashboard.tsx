...
import { TrendingUp, DollarSign, Calendar, CheckCircle, XCircle } from 'lucide-react';
...
export function Dashboard() {
  ...
  const totalInvested = games.filter(g => g.played).length * 3.00; // Custo Lotofácil R$ 3,00
