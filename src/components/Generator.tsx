...
import { Wand2, RefreshCw, AlertCircle, Grid3X3, List, Lock, Save } from 'lucide-react';
...
export function Generator() {
  ...
  const [savedGames, setSavedGames] = useState<number[]>([]); // IDs dos jogos salvos nesta sessão

  const handleGenerate = () => {
    setIsGenerating(true);
    // Limpa jogos anteriores para dar efeito de recarga
    setGames([]);
    
    setTimeout(() => {
      // Passa o status VIP para a lógica. Se false, gera sempre o mesmo jogo do dia.
